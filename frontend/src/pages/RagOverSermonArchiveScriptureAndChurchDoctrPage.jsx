...
export default function RagOverSermonArchiveScriptureAndChurchDoctrPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-rag-over-sermon-archive-scripture-and-church-doctr/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>RAG over sermon archive, scripture, and church doctrine documents for member Q&A</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-rag-over-sermon-archive-scripture-and-church-doctr/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
